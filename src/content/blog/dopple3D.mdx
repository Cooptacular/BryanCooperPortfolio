...
In addition to my Product Management role, I served as the Co-Product Designer.
...
* Integration embedded code generation for pre-set implementation
...
Once published, Users can take the generated embeddable code and easily implement it to their commerce site.
...
Brands can track engagement and performance of their 3D Products with built-in analytics dashboards and reports, and an API integration with GA4 to incorporate their data with their existing analytics stack.
